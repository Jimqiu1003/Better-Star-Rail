...
V0 established governance, compliance boundaries, repository structure, CI, and the C# engineering baseline. V1 is complete and integrated into `main`; it only exercises a project-owned test window and intentionally does not implement real game automation.
